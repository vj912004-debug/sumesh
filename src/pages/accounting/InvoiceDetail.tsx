    ...
    <div className="space-y-6">
      ...
      <div className="bg-white text-black p-8 shadow-sm border rounded-lg max-w-4xl mx-auto print:shadow-none print:border-none print:p-0 font-sans">
        ...
        <div className="flex border border-zinc-400 mb-6 text-sm">
          <div className="w-1/2 border-r border-zinc-400 p-4 flex flex-col justify-between">
            <div>
              <h3 className="font-semibold text-zinc-700 mb-2 border-b border-gray-200 pb-1">Billed To:</h3>
          ...
          <div className="w-1/2 p-0 flex flex-col">
            ...
            <div className="flex border-b border-zinc-400">
              <div className="w-1/2 border-r border-zinc-400 p-2">
                <span className="text-xs text-zinc-500 block">Delivery Note</span>
            ...
            <div className="flex flex-1">
              <div className="w-full p-2">
                <span className="text-xs text-zinc-500 block">Terms of Delivery</span>
        ...
        <table className="w-full border-collapse border border-zinc-400 text-sm mb-6">
          <thead className="bg-zinc-100">
            <tr>
              ...
              <th className="border border-zinc-400 p-2 text-center w-20">HSN/SAC</th>
              ...
              <th className="border border-zinc-400 p-2 text-center w-16">per</th>
          ...
          <tbody className="h-48 align-top">
            {quotation?.items.map((item, index) => {
              ...
              return (
                <tr key={index}>
                  <td className="border-x border-zinc-400 p-2 text-center">{index + 1}</td>
                  <td className="border-x border-zinc-400 p-2">
                    <p className="font-semibold">{product?.name}</p>
                    <p className="text-xs text-gray-600 mt-1">Machine S.No: SP/26/1012</p>
                  </td>
                  <td className="border-x border-zinc-400 p-2 text-center">84212900</td>
                  <td className="border-x border-zinc-400 p-2 text-center font-semibold">{item.quantity}</td>
                  <td className="border-x border-zinc-400 p-2 text-right">{item.unitPrice.toLocaleString('en-IN')}</td>
                  <td className="border-x border-zinc-400 p-2 text-center">Nos</td>
                  <td className="border-x border-zinc-400 p-2 text-right font-medium">
            ...
            <tr>
              <td className="border-x border-zinc-400 p-2"></td>
              <td className="border-x border-zinc-400 p-2"></td>
              <td className="border-x border-zinc-400 p-2"></td>
              <td className="border-x border-zinc-400 p-2"></td>
              <td className="border-x border-zinc-400 p-2"></td>
          ...
          <tfoot>
            <tr className="border border-zinc-400">
              ...
              <td className="p-2 text-right font-semibold border-l border-zinc-400">₹{totalBasic.toLocaleString('en-IN')}</td>
            </tr>
            <tr className="border border-zinc-400">
              <td colSpan={6} className="p-2 text-right">Output CGST @ 9%</td>
              <td className="p-2 text-right border-l border-zinc-400">₹{(totalGST/2).toLocaleString('en-IN')}</td>
            </tr>
            <tr className="border border-zinc-400">
            ...
            <tr className="border border-zinc-400 bg-gray-50">
              ...
              <td className="p-2 text-right font-bold border-l border-zinc-400 text-lg">₹{grandTotal.toLocaleString('en-IN')}</td>
            </tr>
          </tfoot>
        </table>
        ...
        <div className="flex text-sm">
          <div className="w-1/2 pr-4">
            ...
            <p className="text-zinc-700 text-xs text-justify">
          ...
          <div className="w-1/2 border border-zinc-400 p-0 flex flex-col">
