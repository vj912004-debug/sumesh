...
export const appNavGroups: ErpNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'New Plant Order Entry', path: p('sales/order-entry') },
      ...
      { name: 'Pending Advance Orders', path: p('sales/pending-orders') },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Material Issue Multi Level', path: p('inventory/material-issue-multi') },
      ...
      { name: 'Batch/Heat No. Tracking', path: p('inventory/batch-heat-tracking'), componentKey: 'plate-tracking' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Despatch Summary', path: p('mis/despatch-summary') },
      { name: 'Delivery Analysis', path: p('mis/delivery-analysis') },
      { name: 'E-Way Bills', path: p('eway-bills'), componentKey: 'eway-bills' },
      { name: 'Weighbridge Logs', path: p('transport/weigh-bridge'), componentKey: 'weigh-bridge' },
      { name: 'Transport Bill Entry', path: p('transport/bill-entry') },
      { name: 'Transport Bill Register', path: p('transport/bills') },
      { name: 'Pending Freight Dispatch', path: p('transport/pending') },
      { name: 'Transport Wise Summary', path: p('transport/summary') },
      { name: 'Supply Chain & Heavy Fleet', path: p('logistics'), componentKey: 'logistics' },
    ],
  },
  {
    title: 'Job Work',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'On-site Filtration Service', path: p('after-sales/filtration-service'), componentKey: 'filtration-service' },
      { name: 'Complaint Type Master', path: p('service/complaint-type') },
      { name: 'Service Contract Master', path: p('service/contract-master') },
      { name: 'Service Call/Complaint', path: p('service/service-call') },
      { name: 'Erection & Commissioning', path: p('service/erection-commissioning') },
      { name: 'Feedback Question Master', path: p('service/feedback-questions') },
