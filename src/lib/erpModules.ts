...
export const appNavGroups: ErpNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Item Master', path: p('master/item-master'), componentKey: 'item-master' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Finish Item Stock Status', path: p('inventory/finish-stock'), componentKey: 'finish-stock' },
  ...
  },
  {
    ...
    icon: Wrench,
    items: [
      { name: 'Job Work Challan', path: p('inventory/job-work-challan'), componentKey: 'job-work-challan' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Area-wise Customer Report', path: p('reports/customers-by-area'), componentKey: 'customers-by-area' },
